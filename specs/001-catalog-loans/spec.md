...
- **Ejemplar**: copia física de un Título. Atributos: código de ejemplar (único en el catálogo), estado (disponible / prestado / retirado), motivo de retirada (cuando aplica), ubicación / signatura topográfica (opcional). Relación: pertenece a un Título; participa en cero o varios Préstamos a lo largo del tiempo.
